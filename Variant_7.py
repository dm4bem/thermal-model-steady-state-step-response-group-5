...
#TC = dm4bem.file2TC('C:/Users/paula/OneDrive/Dokumente/Uni/Semester 6/energy management in buildings/TC.csv', name='', auto_number=False)
...
pd.read_csv('C:/Users/paula/OneDrive/Dokumente/Uni/Semester 6/energy management in buildings/TC_0.csv')
...
if controller:
    TC['G']['q11'] = 1e-3        # Kp -> ∞, almost perfect controller
